...
const addWord = async (data) => {
  const result = await db.query(
    `INSERT INTO unverifiedwords(balochi_word, urdu_word, english_word, roman_balochi_word)
    Values ('${data.balochi_word}', '${data.urdu_word}', '${data.english_word}', '${data.roman_balochi_word}');`
  );
  return result;
};
...
const dbSaveAnUnverifiedWords = async (data) => {
  const result = await db.query(
    `INSERT INTO words(balochi_word, urdu_word, english_word, roman_balochi_word)
    Values ('${data.balochi_word}', '${data.urdu_word}', '${data.english_word}', '${data.roman_balochi_word}');`
  );
